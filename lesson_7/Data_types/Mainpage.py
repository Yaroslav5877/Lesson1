...
class MainPage:
    ...
    def find_fields(self):
        ...
        self._button = (By.CSS_SELECTOR, 'button')
    ...
    def click_submit_button(self):
        print("Ожидание кликабельности кнопки...")
        submit_button = WebDriverWait(self.browser, 60).until(EC.element_to_be_clickable(self._button))
        print("Кнопка кликабельна, выполняется клик.")
        submit_button.click()
